...
define_constant!(OP_NULL, 0x0D);
define_constant!(OP_NOT, 0x0E);
define_constant!(OP_MINUS, 0x0F);
define_constant!(OP_GET_GLOBAL, 0x10, 2);
define_constant!(OP_SET_GLOBAL, 0x11, 2);
define_constant!(OP_GET_LOCAL, 0x12, 1);
define_constant!(OP_SET_LOCAL, 0x13, 1);
define_constant!(OP_CURRENT_CLOSURE, 0x14, 1);
define_constant!(OP_AND, 0x15);
